...
//Read in CSV and append the data to chart
d3.csv("./data/data.csv").then(function (data) {
    ...
    var xLinearScale = xScale(data, userChoiceXAxis);
    var yLinearScale = yScale(data, userChoiceYAxis);
    ...
    xLabelsGroup.selectAll("text")
        .on("click", function () {
            ...
            if (value != userChoiceXAxis) {
                ...
                xLinearScale = xScale(data, userChoiceXAxis);  //update x scale for new data
    ...
    yLabelsGroup.selectAll("text")
        .on("click", function () {
            ...
            if (value != userChoiceYAxis) {
                ...
                yLinearScale = yScale(data, userChoiceYAxis);
...
function xScale(data, userChoiceXAxis) {
    //create scales
    var xLinearScale = d3.scaleLinear()
        .domain([d3.min(data, d => d[userChoiceXAxis]) * 0.6,
        d3.max(data, d => d[userChoiceXAxis]) * 1.1])
        .range([0, width]);
...
function yScale(data, userChoiceYAxis) {
    //create scales
    var yLinearScale = d3.scaleLinear()
        .domain([d3.min(data, d => d[userChoiceYAxis]) * 0.6,
        d3.max(data, d => d[userChoiceYAxis]) * 1.1])
        .range([height, 0]);
